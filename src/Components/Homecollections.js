        ...
        {images.map((item) => (
          <SwiperSlide >
            <Grid container justifyContent={'center'} sx={{backgroundColor:'#FFFFFF'}}>
              <Grid item container sx={{ display: 'flex', width: { xs: '90%', sm: '95%', md: '100%' }, justifyContent: 'center', marginTop: '20px' }} >
                <Grid item xs={12} sm={4} md={5} sx={{ backgroundColor: item.color, textAlign: { xs: 'center', sm: 'center', md: 'start' }, alignContent: 'center', justifyContent: 'center', padding: { xs: '10px', sm: '45px', md: '0' }, position: { sm: 'absolute', md: 'static' }, zIndex: 1, top: '30%', right: '490px' }}>
                  <Typography sx={{ fontSize: { xs: '15px', sm: '11px', md: '20px', lg: '35px' }, marginBottom: { md: '5px' }, color: '#FFFFFF', fontWeight: { sm: 'bold' } }}>{item.sidecontent}</Typography>
                  <Divider sx={{ backgroundColor: '#FFFFFF', height: { xs: '1px' }, display: { xs: 'none', sm: 'none', md: 'block' } }} />

                  <Typography sx={{ fontSize: { xs: '13px', sm: '16px', lg: '20px' }, marginBottom: '0.5px', marginTop: { xs: '4px', sm: '10px' }, color: '#FFFFFF', textDecoration: { xs: 'underline', sm: 'none' } }}>{item.sidecontent2}</Typography>

                </Grid>
                <Grid item xs={12} sm={12} md={7} sx={{ marginBottom: { xs: '0px' } }}>
