    ...
    return (
       <>
            <controls.Grid container justifyContent={'center'} >
                ...
                <controls.Typography sx={{color:'#6A4EA4', fontSize: { xs: '18px', sm: '25px', md: '28px', lg: '30px' }, fontWeight: { xs: 700 }, marginTop: { xs: '20px', },marginBottom:{xs:'20px'} }}>Pet Lover's Top Picks</controls.Typography>
                </controls.Grid>
            </controls.Grid>
            <controls.Grid container justifyContent="center">
...
export default DetailsTopPicks;